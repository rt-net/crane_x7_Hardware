...
CRANE-X7は、アールティで開発した研究用アームロボットです。このリポジトリのcad_dataは、ShareAlike 3.0（CC BY-NC-SA 3.0）ライセンス（詳細はこちら"ハードウェアCreativeCommonsLicense CC BY-NC-SA 3.0.txt"を参照）で公開されています。
